...
<nav id="myNav">
    <div class="menu-items">
        <ul class="nav-links">
            ...
            <li class="{{ request()->is('training/pre-test') ? 'active' : '' }}">
            ...
            <li class="{{ request()->is('training/post-test') ? 'active' : '' }}">
            ...
            <?php $employee_ids = ['01220014', '01220023', '01210018', '01080019', '01970045', '01110024', '01210027']; ?>
